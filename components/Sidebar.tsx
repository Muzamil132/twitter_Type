...
const {data:session} =useSession()
  return (
    ...
    >
      <div className='w-14 h-14   sm:w-20 sm:h-20  flex justify-center items-center hoverAn  p-0 sm:p-3 xl:ml-24'>
      ...
      <button className="hidden py-3 xl:inline ml-auto bg-[#1d9bf0] text-white rounded-full w-56 h-[52px] text-lg font-bold shadow-md hover:bg-[#1a8cd8]">
        Tweet
      </button>
      <div
